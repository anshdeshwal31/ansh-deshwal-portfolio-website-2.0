  ...
  return (
    <div className="absolute top-[1em] z-[1000] w-full left-0 md:w-auto md:left-1/2 md:-translate-x-1/2">
      ...
      >
        <div
          ref={navItemsRef}
          className="relative items-center rounded-full hidden md:flex p-1 border border-white/10"
          style={{
            height: "var(--nav-h)",
              ...
              return (
                <li key={item.href} role="none" className="flex h-full">
                  <a
                    role="menuitem"
                    href={item.href}
                    className="relative overflow-hidden inline-flex items-center justify-center h-full no-underline rounded-full box-border font-semibold text-[14px] leading-[0] tracking-[0.2px] whitespace-nowrap cursor-pointer px-0"
                    style={pillStyle}
      ...
      <div
        ...
        style={{ ...cssVars, background: "var(--base, #f0f0f0)" } as React.CSSProperties}
      >
